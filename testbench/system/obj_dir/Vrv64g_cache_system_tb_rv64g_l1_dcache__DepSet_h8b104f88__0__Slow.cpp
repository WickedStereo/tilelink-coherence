...
VL_ATTR_COLD void Vrv64g_cache_system_tb_rv64g_l1_dcache___ctor_var_reset(Vrv64g_cache_system_tb_rv64g_l1_dcache* vlSelf) {
    ...
    VL_SCOPED_RAND_RESET_W(4096, vlSelf->__PVT__u_arrays__DOT__bank_rdata_way, __VscopeHash, 15864538516401445536ull);
    VL_SCOPED_RAND_RESET_W(3392, vlSelf->__PVT__u_arrays__DOT__bank_tag_way, __VscopeHash, 2045247564698460404ull);
    VL_SCOPED_RAND_RESET_W(128, vlSelf->__PVT__u_arrays__DOT__bank_state_way, __VscopeHash, 14954234444524230983ull);
    VL_SCOPED_RAND_RESET_W(512, vlSelf->__PVT__u_arrays__DOT__bank_rdata_sel, __VscopeHash, 4758890076537709159ull);
    ...
    VL_SCOPED_RAND_RESET_W(424, vlSelf->__PVT__u_arrays__DOT__scalar_tag_way_r, __VscopeHash, 16760445648792817683ull);
    vlSelf->__PVT__u_arrays__DOT__scalar_state_way_r = VL_SCOPED_RAND_RESET_I(16, __VscopeHash, 3548718919364090609ull);
