...
#endif
            VL_FATAL_MT("rv64g_cache_system_tb.v", 3, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vrv64g_cache_system_tb___024root___dump_triggers__act(Vrv64g_cache_system_tb___024root* vlSelf) {
    ...
    if ((0x1000000000ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 36 is active: @(posedge rv64g_cache_system_tb.clk)\n");
    }
    if ((0x2000000000ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 37 is active: @(negedge rv64g_cache_system_tb.rst_n)\n");
    }
    ...
    if ((0x8000000000ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 39 is active: @( rv64g_cache_system_tb.dut.gen_l1[0].l1.gnt_o)\n");
    }
    if ((0x10000000000ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 40 is active: @( rv64g_cache_system_tb.dut.gen_l1[0].l1.rvalid_o)\n");
    }
    if ((0x20000000000ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 41 is active: @( rv64g_cache_system_tb.dut.gen_l1[1].l1.gnt_o)\n");
    }
    if ((0x40000000000ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 42 is active: @( rv64g_cache_system_tb.dut.gen_l1[1].l1.rvalid_o)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vrv64g_cache_system_tb___024root___dump_triggers__nba(Vrv64g_cache_system_tb___024root* vlSelf) {
    ...
    if ((0x1000000000ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 36 is active: @(posedge rv64g_cache_system_tb.clk)\n");
    }
    if ((0x2000000000ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 37 is active: @(negedge rv64g_cache_system_tb.rst_n)\n");
    }
    ...
    if ((0x8000000000ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 39 is active: @( rv64g_cache_system_tb.dut.gen_l1[0].l1.gnt_o)\n");
    }
    if ((0x10000000000ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 40 is active: @( rv64g_cache_system_tb.dut.gen_l1[0].l1.rvalid_o)\n");
    }
    if ((0x20000000000ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 41 is active: @( rv64g_cache_system_tb.dut.gen_l1[1].l1.gnt_o)\n");
    }
    if ((0x40000000000ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 42 is active: @( rv64g_cache_system_tb.dut.gen_l1[1].l1.rvalid_o)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vrv64g_cache_system_tb___024root___ctor_var_reset(Vrv64g_cache_system_tb___024root* vlSelf) {
    ...
    vlSelf->__VdfgRegularize_ha466d25c_0_0 = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 3615174914254657099ull);
    vlSelf->__VdfgRegularize_ha466d25c_0_1 = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 15982052735269451482ull);
    vlSelf->__VdfgRegularize_h5e6fa50a_0_0 = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 8656963683585414434ull);
    vlSelf->__VdfgRegularize_h5e6fa50a_0_1 = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 1677494167981968517ull);
    vlSelf->__VdfgRegularize_hd09a38b2_0_0 = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 5189567072907842442ull);
    vlSelf->__VdfgRegularize_hd09a38b2_0_1 = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 8299535700301360418ull);
    ...
    for (int __Vi0 = 0; __Vi0 < 111; ++__Vi0) {
